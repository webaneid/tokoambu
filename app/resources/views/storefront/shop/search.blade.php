    ...
    <div class="flash-sale-page__header">
        <div>
            @if(!empty($searchQuery))
                ...
                <p>Ditemukan {{ number_format($totalResults) }} produk untuk "{{ $searchQuery }}"</p>
            @else
    ...
    @else
        <div class="empty-state">
            ...
            <div>
                ...
                @if(!empty($searchQuery))
                    <p class="empty-state__text">Tidak ada produk yang cocok dengan pencarian "{{ $searchQuery }}"</p>
                @else
                    <p class="empty-state__text">Silakan masukkan kata kunci pencarian</p>
                @endif
            </div>
        </div>
    @endif
