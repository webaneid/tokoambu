<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <span class="text-gray-900">Tambah Vendor</span>
        </div>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-semibold mb-6">Form Tambah Vendor</h3>
                    ...
                    <form action="{{ route('vendors.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-primary @error('name') border-red-500 @enderror" placeholder="Nama Vendor" required>
                            @error('name')
